...
const SUBJECT_RULES: Rule[] = [
  ...
  { match: /mini golf|putting green|putting area|golf tee.off|tee.off area|driving.*tee/, room: 'Golf tee-off area' },
  ...
  { match: /master suite|primary suite/, room: 'Master Suite', floor: 'listing' },
