...
const faqs = [
  {
    ...
    a: 'The River House can be booked as the entire property (up to 16 guests, 4 bedrooms, 9 beds), as Upstairs River House on its own (up to 14 guests, 2 bedrooms), or as the River Suite (up to 4 guests, 1 bedroom). Every option includes the river, dock, kayaks and pool.',
  },
  {
